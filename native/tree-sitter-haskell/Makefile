...
HOMEPAGE_URL := https://github.com/tek/tree-sitter-haskell
VERSION := 1.0.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/haskell '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/haskell
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/haskell
