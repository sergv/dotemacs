  ...
  (let ((buf (get-buffer buffer-name)))
    (cond
      ...
      ((string-match-p (rx bol
                           ...
                           eol)
                       buffer-name)
       ;; This version depends on ordering of PATH entries which macos likes to mess up
       ;; by placing /bin at the front thus defeating the purpose of the whole exercise.
       ;; ((base-emacs-fixes--shell-exe "/usr/bin/env")
