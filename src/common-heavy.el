...
(declare-function cached-executable-find "common")
(declare-function char->string "common-small")
(declare-function char= "common-small")
(declare-function comp-hint-cons "common-small")
(declare-function different-files-fast? "common")
(declare-function dired-get-filename "dired")
(declare-function ediff-diff-files-recursive-edit "ediff-setup")
(declare-function ffap-guesser "ffap")
(declare-function find-rec "find-files")
(declare-function indirect-aware-save-buffer "indirect-aware-save-buffer")
(declare-function ivy-completing-read "ivy")
(declare-function join-lines "common")
(declare-function json-encode "json")
(declare-function list->string "common-small")
(declare-function normalise-file-name "common")
(declare-function org-element-map "org-element")
(declare-function org-element-parse-buffer "org-element")
(declare-function org-element-put-property "org-element")
(declare-function persistent-narrow-to-region "common")
(declare-function read-string-no-default "common")
(declare-function remove-whitespace "common-whitespace")
(declare-function search-property "search-prop")
(declare-function select-mode-exit "select-mode")
(declare-function select-mode-setup "select-mode")
(declare-function select-mode-start-selection "select-mode")
(declare-function string->list "common-small")
(declare-function string->number "common-small")
(declare-function strip-trailing-slash "init")
(declare-function version-control-directory? "common")
