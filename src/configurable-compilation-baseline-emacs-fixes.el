;; configurable-compilation-baseline-emacs-fixes.el --- -*- lexical-binding: t; -*-
    ...
    (let* ((name-of-mode
	  ...
	  (if highlight-regexp
	      ...
	      (insert "-*- mode: "
		      ...
		      " -*-\n"))
            (insert (configurable-compilation--unimportant-text "-*- mode: ")
                    (configurable-compilation--unimportant-text name-of-mode)
                    (configurable-compilation--unimportant-text "; default-directory: ")
                    (configurable-compilation--unimportant-text (prin1-to-string (abbreviate-file-name default-directory)))
    ...
    (let* ((name-of-mode
	  ...
	  (if highlight-regexp
	      ...
	      (compilation-insert-annotation
	       ...
	       " -*-\n"))
            (compilation-insert-annotation
             (configurable-compilation--unimportant-text "-*- mode: ")
             (configurable-compilation--unimportant-text name-of-mode)
             (configurable-compilation--unimportant-text "; default-directory: ")
             (configurable-compilation--unimportant-text (prin1-to-string (abbreviate-file-name default-directory)))
             (configurable-compilation--unimportant-text " -*-\n")))
...
;; configurable-compilation-baseline-emacs-fixes.el ends here
