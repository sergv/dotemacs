...
(defun haskell-misc-combined-indent-backwards ()
  ...
  (interactive "*")
  (haskell-ts-indent-line-or-fallback #'haskell-indentation-indent-backwards))
              ...
              (insert " ("
                      (if parent-name
                          (concat (if (s-starts-with? ":" parent-name)
                                  ...
                                  "(")
                        "")
                      (if (haskell-misc--is-operator? propertized-ident)
