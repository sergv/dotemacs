...
(declare-function vim:motion-bwd-symbol "vim-motions")
(declare-function vim:motion-fwd-symbol-end "vim-motions")
(declare-function vim:motion-fwd-symbol "vim-motions")
(declare-function vim:motion-outer-symbol "vim-motions")
(declare-function vim:motion-inner-symbol "vim-motions")
(declare-function vim:motion-bwd-WORD "vim-motions")
(declare-function vim:motion-bwd-WORD-end "vim-motions")
(declare-function vim:motion-fwd-WORD-end "vim-motions")
(declare-function vim:motion-fwd-WORD "vim-motions")
(declare-function vim:motion-bwd-word "vim-motions")
(declare-function vim:motion-bwd-word-end "vim-motions")
(declare-function vim:motion-fwd-word-end "vim-motions")
(declare-function vim:motion-fwd-word "vim-motions")
...
(declare-function vim-change-motion-begin "vim-core" (motion new-begin))
...
;;;###autoload (autoload 'vim:splice-sexp-killing-backward "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:splice-sexp-killing-backward:interactive "paredit-setup" "" t)
(vimmize-function paredit-splice-sexp-killing-backward :name vim:splice-sexp-killing-backward :call-n-times t)
;;;###autoload (autoload 'vim:splice-sexp-killing-forward "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:splice-sexp-killing-forward:interactive "paredit-setup" "" t)
(vimmize-function paredit-splice-sexp-killing-forward :name vim:splice-sexp-killing-forward :call-n-times t)


;;;###autoload (autoload 'vim:backward-slurp-sexp "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:backward-slurp-sexp:interactive "paredit-setup" "" t)
(vimmize-function paredit-backward-slurp-sexp :name vim:backward-slurp-sexp :call-n-times t)
;;;###autoload (autoload 'vim:backward-barf-sexp "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:backward-barf-sexp:interactive "paredit-setup" "" t)
(vimmize-function paredit-backward-barf-sexp :name vim:backward-barf-sexp :call-n-times t)
;;;###autoload (autoload 'vim:forward-slurp-sexp "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:forward-slurp-sexp:interactive "paredit-setup" "" t)
(vimmize-function paredit-forward-slurp-sexp :name vim:forward-slurp-sexp :call-n-times t)
;;;###autoload (autoload 'vim:forward-barf-sexp "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:forward-barf-sexp:interactive "paredit-setup" "" t)
(vimmize-function paredit-forward-barf-sexp :name vim:forward-barf-sexp :call-n-times t)

;;;###autoload (autoload 'vim:splice-sexp "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:splice-sexp:interactive "paredit-setup" "" t)
(vimmize-function paredit-splice-sexp :name vim:splice-sexp :call-n-times t)
;;;###autoload (autoload 'vim:split-sexp "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:split-sexp:interactive "paredit-setup" "" t)
(vimmize-function paredit-split-sexp :name vim:split-sexp :call-n-times t)
;;;###autoload (autoload 'vim:join-sexps "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:join-sexps:interactive "paredit-setup" "" t)
(vimmize-function paredit-join-sexps :name vim:join-sexps :call-n-times t)
;;;###autoload (autoload 'vim:raise-sexp "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:raise-sexp:interactive "paredit-setup" "" t)
(vimmize-function paredit-raise-sexp :name vim:raise-sexp :call-n-times t)
;;;###autoload (autoload 'vim:wrap-sexp "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:wrap-sexp:interactive "paredit-setup" "" t)
(vimmize-function paredit-wrap-sexp :name vim:wrap-sexp :call-n-times t)
;;;###autoload (autoload 'vim:convolute-sexp "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:convolute-sexp:interactive "paredit-setup" "" t)
...
;;;###autoload (autoload 'vim:paredit-forward-kill "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:paredit-forward-kill:interactive "paredit-setup" "" t)
(vimmize-function paredit-forward-kill :name vim:paredit-forward-kill :call-n-times nil :has-count t)
;;;###autoload (autoload 'vim:paredit-backward-kill "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:paredit-backward-kill:interactive "paredit-setup" "" t)
(vimmize-function paredit-backward-kill :name vim:paredit-backward-kill :call-n-times nil :has-count t)

;;;###autoload (autoload 'vim:paredit-forward-kill-word "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:paredit-forward-kill-word:interactive "paredit-setup" "" t)
(vimmize-function paredit-forward-kill-word :name vim:paredit-forward-kill-word :call-n-times t)
;;;###autoload (autoload 'vim:paredit-backward-kill-word "paredit-setup" "" nil)
;;;###autoload (autoload 'vim:paredit-backward-kill-word:interactive "paredit-setup" "" t)
