...
(defparameter-local search/direction nil
  "Direction currently being searched in. Either 'forward or 'backward.")
...
(defun search/start-minibuffer-search (direction prompt case-sensetive)
...
(defun search/optionally-use-info-from-last-search ()
  ...
  (unless (eq? (current-buffer) *search-init-buffer*)
    (search/setup-search-for
     ...
     (buffer-local-value 'search/direction *search-init-buffer*)
     :save-position nil
