...
that next 2 characters are AFTER1 and AFTER2."
  (let ((pt-before (save-excursion
        ...
        (pt-after (save-excursion
                    (skip-syntax-forward " ")
                    (point))))
    (smart-operators--point-surrounded-by2--impl pt-before pt-after before2 before1 after1 after2)))

(defun smart-operators--point-surrounded-by2--impl (pt-before pt-after before2 before1 after1 after2)
  "Check if previous 2 characters before point are BEFORE2 and BEFORE1 and
that next 2 characters are AFTER1 and AFTER2."
...
(defun smart-operators--point-surrounded-by (before after)
  ...
  (let ((pt-before (save-excursion
        ...
        (pt-after (save-excursion
                    (skip-syntax-forward " ")
                    (point))))
    (smart-operators--point-surrounded-by--impl pt-before pt-after before after)))

(defun smart-operators--point-surrounded-by--impl (pt-before pt-after before after)
  "Check if point is surrounded by BEFORE and AFTER characters."
  (let* ((real-before (char-before pt-before))
         (real-after  (char-after pt-after))
         (is-before?  (eq real-before before))
