  ...
  (let* ((base03  "#002b36")
    ...
    (color-theme-install
     `(color-theme-solarized+
       ...
       (ediff-current-diff-A                 ((t (:underline ,yellow))))
       (ediff-current-diff-B                 ((t (:underline ,yellow))))
       (ediff-current-diff-C                 ((t (:underline ,yellow))))
       (ediff-current-diff-Ancestor          ((t (:underline ,violet))))
       (ediff-fine-diff-Ancestor             ((t (:underline ,cyan))))
       (ediff-fine-diff-A                    ((t (:underline ,cyan))))
