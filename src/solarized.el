         ...
         (faces
          `((default                      ((t (:foreground ,base0 :background ,base03))))
            ...
            (tab-bar-tab                  ((((class color) (min-colors 16777216))
                                           ...
                                           (t :inverse-video t)))
            (tab-bar-tab-inactive         ((((class color) (min-colors 16777216))
                                            (:background ,base03))
                                           (t :inverse-video nil)))
            (tab-bar                      ((((class color) (min-colors 16777216))
            ...
            (ediff-fine-diff-Ancestor             ((((supports :underline (:style wave)))
                                                   ...
                                                   (t
                                                    (:underline t))))
            (ediff-fine-diff-A                    ((((supports :underline (:style wave)))
                                                    (:underline (:style wave :color ,magenta)))
                                                   (t
                                                    (:underline t))))
            (ediff-fine-diff-B                    ((((supports :underline (:style wave)))
                                                    (:underline (:style wave :color ,magenta)))
                                                   (t
                                                    (:underline t))))
            (ediff-fine-diff-C                    ((((supports :underline (:style wave)))
                                                    (:underline (:style wave :color ,magenta)))
                                                   (t
                                                    (:underline t))))

            ;; eshell
            (eshell-ls-archive                    ((t (:foreground ,blue :bold t))))
            (eshell-ls-backup                     ((t (:foreground ,orange))))
            (eshell-ls-clutter                    ((t (:foreground ,red))))
            (eshell-ls-directory                  ((t (:foreground ,blue))))
            (eshell-ls-executable                 ((t (:foreground ,green))))
            (eshell-ls-readonly                   ((t (:inherit default :bold t))))
            (eshell-ls-unreadable                 ((t (:inherit default :strike-through t))))
            (eshell-ls-missing                    ((t (:foreground ,red :bold t))))
            (eshell-ls-product                    ((t (:foreground ,violet))))
            (eshell-ls-special                    ((t (:foreground ,magenta))))
            (eshell-ls-symlink                    ((t (:foreground ,cyan))))
            (eshell-prompt                        ((t (:foreground ,violet :bold t))))
