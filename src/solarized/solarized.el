...
(defun solarized-apply-palette (palette)
  ...
  (let* ((mode                      (solarized-palette-mode palette))
    ...
    (solarized-define-faces-into faces
      ...
      (search-green-face :foreground ,background :background ,highlight-green-background)
      (search-cyan-face :foreground ,background :background ,highlight-cyan-background)
      (search-blue-face :foreground ,background :background ,highlight-blue-background)
      (search-violet-face :foreground ,background :background ,highlight-violet-background)
      (search-magenta-face :foreground ,background :background ,highlight-magenta-background)
      ...
      (magit-bisect-bad :foreground ,red :background nil :bold t)
      (magit-bisect-good :foreground ,green :background nil :bold t)
      (magit-bisect-skip :foreground ,yellow :background nil :bold t)
      (magit-blame-hash :inherit magit-hash)
      (magit-blame-heading :inherit highlight)
      (magit-branch-current :foreground ,red :background nil :box t)
      ...
      (magit-hash :foreground ,orange :background nil)
