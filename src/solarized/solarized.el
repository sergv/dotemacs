...
(defun solarized-apply-palette (palette)
  ...
  (let* ((mode                      (solarized-palette-mode palette))
         ...
         (num->color                (lambda (x) (format "#%06x" x)))

         (background                (funcall num->color (solarized-palette-background                palette)))
         (background-highlights     (funcall num->color (solarized-palette-background-highlights     palette)))
         (secondary-content         (funcall num->color (solarized-palette-secondary-content         palette)))
         ...
         (yellow                    (funcall num->color (solarized-palette-yellow                    palette)))
         (green                     (funcall num->color (solarized-palette-green                     palette)))
         (cyan                      (funcall num->color (solarized-palette-cyan                      palette)))
         (blue                      (funcall num->color (solarized-palette-blue                      palette)))
         (violet                    (funcall num->color (solarized-palette-violet                    palette)))
         (magenta                   (funcall num->color (solarized-palette-magenta                   palette)))

         ;; (red-aux-fg                (funcall num->color (solarized-palette-red-aux-fg                palette)))
         ;; (orange-aux-fg             (funcall num->color (solarized-palette-orange-aux-fg             palette)))
         ;; (yellow-aux-fg             (funcall num->color (solarized-palette-yellow-aux-fg             palette)))
         ;; (green-aux-fg              (funcall num->color (solarized-palette-green-aux-fg              palette)))
         ;; (cyan-aux-fg               (funcall num->color (solarized-palette-cyan-aux-fg               palette)))
         ;; (blue-aux-fg               (funcall num->color (solarized-palette-blue-aux-fg               palette)))
         ;; (violet-aux-fg             (funcall num->color (solarized-palette-violet-aux-fg             palette)))
         ...
         ;; (yellow-aux-aux-fg         (funcall num->color (solarized-palette-yellow-aux-aux-fg         palette)))
         ;; (green-aux-aux-fg          (funcall num->color (solarized-palette-green-aux-aux-fg          palette)))
         ;; (cyan-aux-aux-fg           (funcall num->color (solarized-palette-cyan-aux-aux-fg           palette)))
         ;; (blue-aux-aux-fg           (funcall num->color (solarized-palette-blue-aux-aux-fg           palette)))
         ...
         ;; (yellow-aux-aux-aux-fg     (funcall num->color (solarized-palette-yellow-aux-aux-aux-fg     palette)))
         ;; (green-aux-aux-aux-fg      (funcall num->color (solarized-palette-green-aux-aux-aux-fg      palette)))
         ;; (cyan-aux-aux-aux-fg       (funcall num->color (solarized-palette-cyan-aux-aux-aux-fg       palette)))
         ;; (blue-aux-aux-aux-fg       (funcall num->color (solarized-palette-blue-aux-aux-aux-fg       palette)))
         ;; (violet-aux-aux-aux-fg     (funcall num->color (solarized-palette-violet-aux-aux-aux-fg     palette)))
         ;; (magenta-aux-aux-aux-fg    (funcall num->color (solarized-palette-magenta-aux-aux-aux-fg    palette)))

         (red-aux-aux-aux-bg        (funcall num->color (solarized-palette-red-aux-aux-aux-bg        palette)))
         (orange-aux-aux-aux-bg     (funcall num->color (solarized-palette-orange-aux-aux-aux-bg     palette)))
         (yellow-aux-aux-aux-bg     (funcall num->color (solarized-palette-yellow-aux-aux-aux-bg     palette)))
         (green-aux-aux-aux-bg      (funcall num->color (solarized-palette-green-aux-aux-aux-bg      palette)))
         (cyan-aux-aux-aux-bg       (funcall num->color (solarized-palette-cyan-aux-aux-aux-bg       palette)))
         (blue-aux-aux-aux-bg       (funcall num->color (solarized-palette-blue-aux-aux-aux-bg       palette)))
         (violet-aux-aux-aux-bg     (funcall num->color (solarized-palette-violet-aux-aux-aux-bg     palette)))
         (magenta-aux-aux-aux-bg    (funcall num->color (solarized-palette-magenta-aux-aux-aux-bg    palette)))
