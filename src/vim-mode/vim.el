...
(defcustom vim-initial-modes
  (list (cons 'Custom-mode nil)
        ...
        (cons 'clojure-compilation-mode nil)
        (cons 'compilation-mode nil)
        ...
        (cons 'rust-compilation-mode nil)
        (cons 'sldb-mode nil)
