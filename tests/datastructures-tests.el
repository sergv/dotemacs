...
(ert-deftest datastructures-tests/interval-with-margins-merge-overlapping! ()
  (cl-macrolet ((i (start end &optional x y)
                  `(mk-interval-with-margins ,start ,end nil nil ,x ,y nil nil)))
    (should (equal (interval-with-margins-merge-overlapping! (cl-copy-list (list (i 1 2) (i 3 4))))
                   (list (i 1 2) (i 3 4))))
    (should (equal (interval-with-margins-merge-overlapping! (cl-copy-list (list (i 3 4) (i 1 2))))
                   (list (i 1 2) (i 3 4))))
    (should (equal (interval-with-margins-merge-overlapping! (cl-copy-list (list (i 2 4) (i 1 2))))
                   (list (i 1 4))))
    (should (equal (interval-with-margins-merge-overlapping! (cl-copy-list (list (i 2 4) (i 1 2) (i 3 5))))
                   (list (i 1 5))))
    (should (equal (interval-with-margins-merge-overlapping! (cl-copy-list (list (i 3 4) (i 1 2) (i 3 5))))
                   (list (i 1 2) (i 3 5))))
    (should (equal (interval-with-margins-merge-overlapping! (cl-copy-list (list (i 1 10) (i 2 4))))
                   (list (i 1 10))))
    (should (equal (interval-with-margins-merge-overlapping! (cl-copy-list (list (i 1 10) (i 2 4) (i 3 15))))
                   (list (i 1 15))))
    (should (equal (interval-with-margins-merge-overlapping! (cl-copy-list (list (i 1 3) (i 2 4) (i 3 15))))
                   (list (i 1 15))))
    (should (equal (interval-with-margins-merge-overlapping! (cl-copy-list (list (i 1 5 nil 3) (i 7 10))))
                   (list (i 1 10))))
    (should (equal (interval-with-margins-merge-overlapping! (cl-copy-list (list (i 1 5) (i 7 10 2))))
                   (list (i 1 10))))))
