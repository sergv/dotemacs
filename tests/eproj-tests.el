...
(eproj-tests--define-tests
  ...
  (progn
    ...
    (let* ((path eproj-tests/project-with-c-files)
      ...
      (should (nanothunk-p tags-index-thunk))
      (let ((tags-index (nanothunk-force tags-index-thunk)))
...
(eproj-tests--define-tests
  ...
  (let ((path eproj-tests/project-with-eproj-file-and-tags-file))
    (eproj-reset-projects)
    (should (not (null (eproj-get-initial-project-root path nil))))
    (eproj-reset-projects)
    (should (not (null (eproj-get-initial-project-root (concat path "/Foo") nil))))
    (eproj-reset-projects)
...
;;;; eproj/get-fast-tags-vim-tags-from-buffer
