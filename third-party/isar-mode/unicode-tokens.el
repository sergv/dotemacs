...
(defconst unicode-tokens-fontsymb-properties
  `((sub          "Lower"         ,(if (display-graphic-p)
				      '(display (raise -0.4))
				    '(face (:width ultra-condensed :height 0.8 :slant reverse-italic :foreground "LightSalmon4"))))
    (sup          "Raise"         ,(if (display-graphic-p)
				      '(display (raise 0.4))
				    '(face (:width ultra-condensed :height 0.8 :slant italic :foreground "LightSalmon4")))) ;;(display (raise 0.4))
