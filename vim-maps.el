...
(vim:emap "split" 'vim:excmd-split)
(vim:emap "sp" "split")
(vim:emap "vsplit" 'vim:excmd-vertical-split)
(vim:emap "vs" "vsplit")
(vim:emap "new" 'vim:excmd-new)
(vim:emap "vnew" 'vim:excmd-vertical-new)
(vim:emap "vne" "vnew")
(vim:emap "close" 'vim:window-close)
(vim:emap "clo" "close")
(vim:emap "only" 'vim:window-only)
(vim:emap "on" "only")
(vim:emap "quit" 'vim:excmd-quit)
(vim:emap "q" "quit")
(vim:emap "quit!" 'vim:excmd-quit-q)
(vim:emap "q!" "quit")
(vim:emap "wq" 'vim:excmd-save-and-close)
(vim:emap "wq!" 'vim:excmd-save-and-close-q)
(vim:emap "quitall" 'vim:excmd-quit-all)
(vim:emap "quita" "quitall")
(vim:emap "qall" "quitall")
(vim:emap "qa" "qall")
(vim:emap "quitall!" 'vim:excmd-quit-all-q)
(vim:emap "quita!" "quitall!")
(vim:emap "qall!" "quitall!")
(vim:emap "qa!" "qall!")
(vim:emap "wqall" 'vim:excmd-save-and-quit)
(vim:emap "wqa" "wqall")
(vim:emap "xall" "wqall")
(vim:emap "xa" "xall")
